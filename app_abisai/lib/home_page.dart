...
class HomePage extends StatelessWidget {
  ...
  final String nombreUsuario = "González Espinoza Jesús Gabriel";
  final String correoUsuario = "jegagonzalezes@ittepic.edu.mx";
  final String numControl = "C21400585";
  final String rutaImagen = '/profile1.png'; //No olvides cargar tu foto
